            ...
            <el-timeline>
              ...
              >
                <span
                  ...
                  :class="[item.id == selectTagId ? 'sortBoxSpan sortBoxSpanSelect' : 'sortBoxSpan']"
                >
                  {{item.tagTitle}}
                </span>
              </el-timeline-item>
             ...
             <el-timeline :reverse="true">
                ...
                >
                  <el-card shadow="always">
                    ...
                    <el-tag class="elTag" type="success">{{item.tags[0].tagTitle}}</el-tag>
  ...
  export default {
    ...
    methods: {
      getBlogList(){
        ...
        getBlogByTagId(params).then(response => {
      ...
      findAllTag(){
        findAllTag().then(response => {
          ...
          this.selectTagId = response.data[0].id
        })
      },
      // 格式化日期
